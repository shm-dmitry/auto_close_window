...
const uint8_t led_green_POWER_MANAGER_OK[]      PROGMEM = { 4, 1, 250, 0 };
const uint8_t led_red_POWER_MANAGER_OK[]        PROGMEM = { 0, 0 };

const uint8_t led_green_POWER_MANAGER_ERR[]      PROGMEM = { 0, 0 };
const uint8_t led_red_POWER_MANAGER_ERR[]        PROGMEM = { 4, 1, 250, 0 };
...
t_led_data led_data[LED_DATA_ARRAY_SIZE] = {
  ...
  { .red = led_red_POWER_MANAGER_OK,   .green = led_green_POWER_MANAGER_OK },
  { .red = led_red_POWER_MANAGER_ERR,  .green = led_green_POWER_MANAGER_ERR },
};
